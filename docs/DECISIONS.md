...
| Ocean MOQ / countries / VAT / cart `code` | Seeded conservatively in migration 013 (`min_order_value_eur=100`, EU country list guess, `vat_rate=0`). Operator must confirm before activating the vendor |
