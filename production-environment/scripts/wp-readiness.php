 ...
 *
 * Run inside the `ecom` container after the operator has activated plugins and customised the
 * shop, and before the first catalogue import:
 *
 *   docker cp scripts/wp-readiness.php ecom:/tmp/
 *   docker exec -e WP_READINESS_FIX=1 ecom php /tmp/wp-readiness.php
 *
