...
#
#   ~/sillage/scripts/build-push-images.sh
#   ~/sillage/scripts/build-push-images.sh --namespace unseencurtain --tag abc1234
#   ~/sillage/scripts/build-push-images.sh --core-only   # day-2 engine bump; skip WP image
#
