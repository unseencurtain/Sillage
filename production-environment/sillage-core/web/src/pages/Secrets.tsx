    ...
    <div className="space-y-6">
      <header>
        ...
        <p className="text-sm text-muted">
          Vendor API credentials for BeautyFort + BTS. Values are never shown after save — only
          set / empty.
        </p>
      </header>
      ...
      <div className="rounded-xl border border-line bg-panel px-4 py-3 text-sm text-muted">
        <div className="flex items-start gap-2">
          ...
          <div>
            <p>
              Stored in a gitignored overlay file inside the container (
              ...
              hot-reloaded on save and at the start of each sync — no container recreate needed for
              BF/BTS credentials.
            </p>
          ...
          return (
            ...
            >
              ...
              <div className="mt-3 flex flex-wrap items-end gap-2">
                ...
                <button
                  type="button"
                  className="inline-flex items-center gap-1.5 rounded-lg border border-danger/40 bg-red-50 px-3 py-2 text-sm font-medium text-danger hover:bg-red-100 disabled:opacity-50"
                  disabled={busy || !s.set}
                  onClick={() => {
