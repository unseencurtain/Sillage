  ...
  return (
    <div className="flex min-h-screen">
      <aside className="sticky top-0 flex h-screen w-60 shrink-0 flex-col bg-sidebar text-sidebar-ink">
        ...
        {devBox ? (
          // The dev shop is a pixel-for-pixel copy of the live one holding the same vendor
          ...
          <div className="mx-3 mt-3 flex items-start gap-2 rounded-lg bg-amber-400/15 px-3 py-2 text-xs text-amber-200">
            ...
            <span>
              <strong className="font-semibold">Development box.</strong> Vendor orders can never
              leave here — Live is refused.
            </span>
          </div>
        ) : null}
